...
function crc32 (str) {
    ...
    function ajaxCrypt(string){

            return eval("CryptoJS."+$AJAX_REQUEST_PARAMS+"(\""+string+"\")").toString();
    ...
    function base64_decode(Base64string){
        var parsedWordArray = CryptoJS.enc.Base64.parse(Base64string);
